...
from python.pyosirix import ViewerController
import grpc
import pytest
import numpy as np
import matplotlib.pyplot as pl
from python.pyosirix.osirix_utils import Osirix, OsirixService
from python.pyosirix.exceptions import GrpcException

import python.osirixgrpc.osirix_pb2 as osirix_pb2
import python.osirixgrpc.utilities_pb2 as utilities_pb2
import python.osirixgrpc.types_pb2 as types_pb2
import python.osirixgrpc.viewercontroller_pb2 as viewercontroller_pb2
import python.osirixgrpc.vrcontroller_pb2 as vrcontroller_pb2
import python.osirixgrpc.dcmpix_pb2 as dcmpix_pb2
import python.osirixgrpc.roi_pb2 as roi_pb2
import python.osirixgrpc.roivolume_pb2 as roivolume_pb2
import python.osirixgrpc.osirix_pb2_grpc as osirix_pb2_grpc
...
class GrpcTest(unittest.TestCase):
	...
	def setUp(self):
		try:
			...
			print("Connection to Osirix established")
		except:
