...
gRPCServiceMessageImplementation(ViewerControllerWindowInformation, ViewerController, ViewerControllerWindowInformationResponse, gRPCViewerControllerDelegate)
