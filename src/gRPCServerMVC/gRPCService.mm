...
gRPCServiceMessageImplementation(ViewerControllerCopyViewerWindow, ViewerControllerCopyViewerWindowRequest, Response, gRPCViewerControllerDelegate)
gRPCServiceMessageImplementation(ViewerControllerResampleViewerController, ViewerControllerResampleViewerControllerRequest, Response, gRPCViewerControllerDelegate)
...
gRPCServiceMessageImplementation(BrowserControllerOpenViewerFromImages, BrowserControllerOpenViewerFromImagesRequest, BrowserControllerOpenViewerFromImagesResponse, delegateClassgRPCBrowserControllerDelegate)
...
gRPCServiceMessageImplementation(DicomStudyNoFilesExcludingMultiFrames, DicomStudy, DicomStudyNoFilesExcludingMultiFramesResponse, gRPCDicomStudyDelegate)
