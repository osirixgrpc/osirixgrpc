...
#define DCMJPEG_TRACE(msg) /*std::cout << msg*/
#define DCMJPEG_DEBUG(msg) /*std::cout << msg*/
#define DCMJPEG_INFO(msg)  /*std::cout << msg*/
#define DCMJPEG_WARN(msg)  std::cout << msg << std::endl
#define DCMJPEG_ERROR(msg) std::cout << msg << std::endl
#define DCMJPEG_FATAL(msg) std::cout << msg << std::endl
