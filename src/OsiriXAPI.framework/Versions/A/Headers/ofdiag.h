...
#define DCMTK_DIAGNOSTIC_PUSH "diag/push.def"
#define DCMTK_DIAGNOSTIC_POP "diag/pop.def"
#define DCMTK_DIAGNOSTIC_IGNORE_SIGN_COMPARE "diag/signcmp.def"
#define DCMTK_DIAGNOSTIC_IGNORE_OVERFLOW "diag/overflow.def"
#define DCMTK_DIAGNOSTIC_IGNORE_MISMATCHED_TAGS "diag/mmtag.def"
#define DCMTK_DIAGNOSTIC_IGNORE_PREDEFINED_IDENTIFIER_OUTSIDE_FUNCTION "diag/piof.def"
#define DCMTK_DIAGNOSTIC_IGNORE_IMPLICIT_CONVERSION "diag/cnvrsn.def"
#define DCMTK_DIAGNOSTIC_IGNORE_SHADOW "diag/shadow.def"
#define DCMTK_DIAGNOSTIC_IGNORE_NO_SUITABLE_DEFINITION_FOR_TEMPLATE_INSTANTIATION "diag/nsdfti.def"
#define DCMTK_DIAGNOSTIC_IGNORE_VISUAL_STUDIO_PERFORMANCE_WARNING "diag/vsprfw.def"
